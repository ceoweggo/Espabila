...
export const quickTestBlocks: QuestionBlock[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        scaleValues: [
          { min: 1, max: 2, adaptability: 1, rigidity: 4, stability_seeking: 3, mbti_dimension: 'J', ikigai_area: 'profession' },
          { min: 3, max: 3, adaptability: 2, rigidity: 2, stability_seeking: 2, mbti_dimension: null, ikigai_area: null },
          { min: 4, max: 5, adaptability: 4, rigidity: 1, flexibility: 3, mbti_dimension: 'P', ikigai_area: 'passion' }
        ]
      },
      {
        id: "mindscape_3",
      ...
      },
      {
        ...
        optionValues: [
          { practical: 5, concrete: 4, factual: 3, sensing: 4, mbti_dimension: 'S', ikigai_area: 'profession' },
          { conceptual: 5, abstract: 4, theoretical: 3, intuitive: 4, mbti_dimension: 'N', ikigai_area: 'passion' },
          { practical: 4, applied: 5, pragmatic: 3, sensing: 4, mbti_dimension: 'S', ikigai_area: 'vocation' },
          { conceptual: 4, principles: 5, holistic: 3, intuitive: 3, mbti_dimension: 'N', ikigai_area: 'mission' }
        ]
      },
      {
        id: "mindscape_5",
        ...
        scaleValues: [
          { min: 1, max: 2, curiosity: 1, compliance: 4, conformity: 3, mbti_dimension: 'S', ikigai_area: 'profession' },
          { min: 3, max: 3, curiosity: 2, compliance: 2, mbti_dimension: null, ikigai_area: null },
          { min: 4, max: 5, curiosity: 4, questioning: 3, intellectual: 3, mbti_dimension: 'N', ikigai_area: 'mission' }
        ]
      }
    ]
  },
